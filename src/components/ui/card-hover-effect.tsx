...
export const HoverEffect = ({
  ...
  return (
    <div
      className={cn(
        "grid grid-cols-1 gap-4 py-10 md:grid-cols-2", // 1 column on mobile, 2 columns on desktop
        className,
      )}
    >
      {items.map((item, idx) => (
        <div
          key={idx}
          className="group relative grid h-full w-full grid-cols-1 place-items-center p-2"
